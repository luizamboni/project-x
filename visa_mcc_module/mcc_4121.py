...
def processar_mcc_4121(valor_autorizado: float, valor_final: float, taxas: dict) -> dict:
    logging.debug(f"Iniciando processamento MCC 4121: valor_autorizado={valor_autorizado}, valor_final={valor_final}")
    ...
    if valor_final > limite_maximo:
        ...
        return {
            "status": "falha",
            "mensagem": "Valor excede os 20% permitidos para MCC 4121. Requer nova autorização.",
    ...
    return {
        ...
        "valor_liquido_para_o_motorista_ou_empresa": round(valor_liquido, 2)
    }