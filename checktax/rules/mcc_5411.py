...
def processar_mcc_5411(valor_autorizado: float, valor_final: float, taxas: dict) -> dict:
    logging.debug(f"Iniciando processamento MCC 5411: valor_autorizado={valor_autorizado}, valor_final={valor_final}")
    ...
    if valor_final > limite_maximo:
        logging.warning("Valor excede o limite permitido de 15%.")
        return {
            "status": "falha",
